const carDatabase = [
    ...
    },
    {
        ...
        image: "🚗",
        features: ["Kompaktowy", "Stylowy", "Tani", "Miejski"],
        scores: {
    ...
    },
    {
        ...
        image: "🚙",
        features: ["Elegancki", "Jakość", "Przyjemność jazdy", "Niezawodny"],
        scores: {
    ...
    },
    {
        ...
        image: "🚙",
        features: ["7 lat gwarancji", "Nowoczesny", "Dobra cena", "Przestronny"],
        scores: {
    ...
    },
    {
        ...
        image: "🚘",
        features: ["Quattro", "Premium", "Technologia", "Jakość"],
        scores: {
    ...
    },
    {
        ...
        image: "🚗",
        features: ["Niezawodny", "Oszczędny", "Sportowy", "Trwały"],
        scores: {
    ...
    },
    {
        ...
        image: "🚙",
        features: ["Najbezpieczniejszy", "Skandynawski", "Rodzinny", "Premium"],
        scores: {
    ...
    },
    {
        ...
        image: "🚙",
        features: ["Nowoczesny", "5 lat gwarancji", "Hybryda", "Przestronny"],
        scores: {
    ...
    },
    {
        ...
        priceMin: 52000,
        priceMax: 82000,
        priceRange: "52 000 - 82 000 zł",
        image: "🚗",
        features: ["Tani", "Kompaktowy", "Elektryczny dostępny", "Miejski"],
        scores: {
            cena: 9, spalanie: 8, bezpieczenstwo: 7, komfort: 6,
            osiagi: 5, przestrzen: 4, wyposazenie: 6, niezawodnosc: 7, marka: 5
        },
        suitableFor: {
            ages: ["18-25", "26-35"],
            drivingEnv: ["miasto"],
    ...
    },
    {
        ...
        priceMin: 105000,
        priceMax: 175000,
        priceRange: "105 000 - 175 000 zł",
        image: "🚙",
        features: ["Futurystyczny kokpit", "Stylowy", "Hybryda", "Komfortowy"],
        scores: {
            cena: 6, spalanie: 7, bezpieczenstwo: 8, komfort: 8,
            osiagi: 6, przestrzen: 7, wyposazenie: 8, niezawodnosc: 7, marka: 6
        },
        suitableFor: {
            ages: ["26-35", "36-45"],
            drivingEnv: ["mieszane", "miasto"],
            interests: ["technologia", "rodzina"],
            professions: ["kreatywny", "sprzedaz", "it"]
        },
        otomotoSearch: "peugeot-3008"
    },
    {
        id: 18,
        name: "Renault Megane",
        ...
        priceMin: 70000,
        priceMax: 115000,
        priceRange: "70 000 - 115 000 zł",
        image: "🚗",
        features: ["Komfortowy", "Przestronny", "Dobra cena", "Elektryczny dostępny"],
        scores: {
            cena: 7, spalanie: 7, bezpieczenstwo: 7, komfort: 7,
            osiagi: 6, przestrzen: 6, wyposazenie: 7, niezawodnosc: 6, marka: 5
        },
        suitableFor: {
            ages: ["26-35", "36-45"],
            drivingEnv: ["miasto", "mieszane"],
            interests: ["rodzina", "ekologia"],
            professions: ["sprzedaz", "medycyna", "student"]
        },
        otomotoSearch: "renault-megane"
    },
    {
        id: 19,
        name: "Toyota Corolla",
        ...
        priceMin: 85000,
        priceMax: 125000,
        priceRange: "85 000 - 125 000 zł",
        image: "🚗",
        features: ["Najpopularniejszy", "Hybryda", "Niezawodny", "Oszczędny"],
        scores: {
            cena: 7, spalanie: 9, bezpieczenstwo: 8, komfort: 7,
            osiagi: 6, przestrzen: 6, wyposazenie: 7, niezawodnosc: 10, marka: 8
        },
        suitableFor: {
            ages: ["26-35", "36-45", "46-55", "55+"],
            drivingEnv: ["miasto", "mieszane"],
            interests: ["ekologia", "rodzina"],
            professions: ["medycyna", "sprzedaz", "emeryt"]
        },
        otomotoSearch: "toyota-corolla"
    },
    {
        id: 20,
        name: "Seat Leon",
        ...
        priceMin: 80000,
        priceMax: 125000,
        priceRange: "80 000 - 125 000 zł",
        image: "🚗",
        features: ["Sportowy design", "VW jakość", "Dynamiczny", "Nowoczesny"],
        scores: {
            cena: 7, spalanie: 7, bezpieczenstwo: 8, komfort: 7,
            osiagi: 7, przestrzen: 6, wyposazenie: 8, niezawodnosc: 7, marka: 6
        },
        suitableFor: {
            ages: ["18-25", "26-35"],
            drivingEnv: ["miasto", "mieszane"],
            interests: ["predkosc", "technologia"],
            professions: ["student", "kreatywny", "sprzedaz"]
        },
        otomotoSearch: "seat-leon"
    }
];
